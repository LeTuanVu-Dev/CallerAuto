...
open class PermissionActivity :
    ...
    open fun checkToggle() {
        ...
        binding.ivToggleStorage.isEnabled = !isGrantStoragePermission()
        ...
        binding.ivToggleStorage.setImageResource(if (isGrantStoragePermission()) R.drawable.ic_toggle_on else R.drawable.ic_toggle_off)

        if (readPhonePermissionGrant(this) && isGrantStoragePermission()) {
