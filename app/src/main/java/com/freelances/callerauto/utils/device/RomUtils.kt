...
import com.freelances.callerauto.utils.device.HuaweiUtils.REQUEST_CODE_FLOAT_WINDOW
    ...
    private fun checkOp(context: Context, op: Int): Boolean {
        ...
        if (version >= 19) {
            ...
            try {
                ...
                System.out.println("DKKKKKKK-" +  method.invoke(manager, op, Binder.getCallingUid(), context.packageName) as Int)
